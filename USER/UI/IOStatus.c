...
{ TEXT_CreateIndirect,"*绿色为低电平（合）",label1_IOStatus,15,416,192,25,0,0x0,0 },
{ TEXT_CreateIndirect,"*红色为高电平（开）",label2_IOStatus,15,446,192,25,0,0x0,0 },
};
